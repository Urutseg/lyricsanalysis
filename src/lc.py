...
class LyricsCharter(object):
    ...
    def songs_by_decade(self):
        """Produces a chart for song count"""
    ...
    def word_counts_density(self):
        """Produces two histograms for songs' word counts"""
    ...
    def word_counts_trend(self):
        """Charts for lexical density over years"""
    ...
    def word_counts_vs_unique(self):
        """Produces three variations of a jointplot over word counts"""
